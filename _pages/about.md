...
<div style="width: 300px; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: transform 0.3s;">
  <a href="#" style="text-decoration: none; color: inherit;">
    <img src="www.natdave.github.io/images/headshot.jpg" alt="Traffic Signal Optimization" style="width: 100%; height: auto;">
...
<div style="width: 300px; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: transform 0.3s;">
  <a href="#" style="text-decoration: none; color: inherit;">
    <img src="www.natdave.github.io/images/headshot.jpg" alt="AI & ML in Transportation" style="width: 100%; height: auto;">
    <div style="padding: 15px;">
...
<div style="width: 300px; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: transform 0.3s;">
  <a href="#" style="text-decoration: none; color: inherit;">
    <img src="www.natdave.github.io/images/headshot.jpg" alt="Active Transportation & Sustainability" style="width: 100%; height: auto;">
    <div style="padding: 15px;">
